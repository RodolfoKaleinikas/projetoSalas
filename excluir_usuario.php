...
<section class="container">
  <div class="row">
    <div class="col-12 d-flex justify-content-center flex-column align-items-center">
      <form name="form" id="formulario" action="confirmaExcluirUsuario.php" method="POST" class="col-12 d-flex justify-content-center flex-column form_cadastro_tarefa">
        <input type="hidden" name="pessoa_id" value="<?php echo $pessoa_id; ?>">

        <label for="nome_usuario">Nome</label>
        <input type="text" value="<?php echo $nome; ?>" name="nome_usuario" id="nome_usuario" readonly>

        <label for="sobrenome_usuario">Sobrenome</label>
        <input type="text" value="<?php echo $sobrenome; ?>" name="sobrenome_usuario" id="sobrenome_usuario" readonly>

        <label for="email_usuario">Email</label>
        <input type="email" value="<?php echo $login; ?>" name="email_usuario" id="email_usuario" readonly>

        <label for="senha_usuario">Senha</label>
        <input type="password" value="<?php echo $senha; ?>" name="senha_usuario" id="senha_usuario" readonly>

        <label for="fone_usuario">Telefone</label>
        <input type="number" value="<?php echo $telefone; ?>" name="fone_usuario" id="fone_usuario" readonly>

        <label for="departamento_usuario">Departamento</label>
        <input type="text" value="<?php echo $departamento; ?>" name="departamento_usuario" id="departamento_usuario" readonly>
