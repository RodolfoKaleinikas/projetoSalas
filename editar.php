...
<section class="container">
  <div class="row">
    <div class="col-12 d-flex justify-content-center flex-column align-items-center">
      <form name="form" id="formulario" action="verificaAltera.php" method="POST" class="col-12 d-flex justify-content-center flex-column form_cadastro_tarefa">
        ...
        <input type="date" value="<?php echo $data_reserva; ?>" name="data_reserva" id="data_reserva">
        ...
        <textarea name="desc" cols="6" rows="6">
        <?php echo $descricao; ?>
        </textarea>
